(function() {
  ...
  batik = function(fn) {
    var render;
    render = function() {
      var args, name, renderer;
      name = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      renderer = batik.getRenderer(this.self, name);
      if (renderer) {
        return this.que.push(renderer.apply(this.self, args));
      }
    };
    return function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return batik.render.apply({
        self: this,
        render: render
      }, [fn].concat(args));
    };
...
|tr|tt|u|ul|video|xmp'.replace(/\n/g, '').split('|');
  ...
  batik.render = function() {
    var args, fn, key, scope;
  ...
  batik.getRenderer = function(scope, name) {
    name = name.charAt(0).toUpperCase() + name.slice(1);
    if (typeof scope["render" + name] === 'function') {
